...
public class InputManager : GenericSingleton<InputManager>
{
	...
	private KeyCode[][] KeyboardControls = { new KeyCode[] { KeyCode.H, KeyCode.Space }, new KeyCode[] { KeyCode.J }, new KeyCode[] { KeyCode.K, }, new KeyCode[] { KeyCode.L }, new KeyCode[] { KeyCode.None }, new KeyCode[] { KeyCode.None }, new KeyCode[] { KeyCode.LeftShift, KeyCode.RightShift }, new KeyCode[] { KeyCode.Escape, KeyCode.Return } };
